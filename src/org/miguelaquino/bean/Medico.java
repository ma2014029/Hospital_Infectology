...
public class Medico {
    private int codigoMedico;//coleccion de datos
    ...
    public Medico(int codigoMedico, int licenciaMedica, String nombres, String apellidos, String horaEntrada, 
                    String horaSalida, int turnoMaximo, String sexo) {
